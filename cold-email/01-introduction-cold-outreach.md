...
How did cold outreach help them? We programmatically scraped blogs to find people who were using a competing plugin. Then, we used a virtual assistant to pull the name of the company behind the site and looked up the owner’s email address on [Clearbit](https://connect.clearbit.com/). We sent them a cold email referencing **the exact competing plugin that they were using and why it was worse than ours.**
