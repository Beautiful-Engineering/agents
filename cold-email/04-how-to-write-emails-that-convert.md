...
- **A thesis**: The style and tone of the email you want to test. Make sure each thesis considers what sort of behaviour you’re trying to drive:

- “Humble and inquisitive” tone should drive a booked call from the prospect.
- “Educational and value-driven” tone should drive a click through to a helpful resource.
- “Straightforward and honest” tone could prompt a quick reply.

- ‍**Subject options**: At least 3 different subject lines. Then choose your favorite by surveying people on your team.
...
- **Ask a question to pique interest:** *Hey {{first.name}}—curious if you have to log into a bunch of different places to manage {{company}}’s health insurance, 401K, FSA / HSA, and other benefits?*
- **Address a pain point:** *Hey {{first.name}}—I noticed you work with 6 different vendors to manage {{company}}’s adtech. We can help you manage them all in a single system, if you’re interested.*
- **Demonstrate clear value:** *Hey {{first.name}}—want to run something by you that can help you complete {{insert SaaS thing}} in 2-3 days, instead of 2-3 weeks.*
...
- ‍**Keep it relevant to work**: Signal to the prospect that they’re uniquely fit for your solution.

- ‍*Since I saw that you invest in startups in addition to your role at Demand Curve, I thought you’d like this.*‍
- ‍*P.S. we’re in the X Slack group together. Loved your post on referral programs.*‍
- ‍*We met back at SXSW in 2018. Really enjoyed our chat about XYZ. Glad you’re doing well!*‍

- ‍**Get personal**: Connect through a personal note that’s unrelated to work. You might build trust with your prospect. Then they’ll be more likely to buy from you.

- ‍*BTW, saw you played soccer in college. I played at URI. You still playing these days?*‍
- ‍*One more thing. I saw on your personal site that you make music. I love music, myself. Actually listened to (name of their song) on spotify. Loved it!*‍
- ‍*[Mutual friend] mentioned you live in SOMA. Even if this isn’t a fit, let’s grab a coffee one of these days!*‍
- ‍*On a personal note, I see you’re working with Big Brothers Big Sisters. I volunteer with them myself—one of my favorite projects.*‍
- ‍*P.S. really liked your blog post on climbing Kilimanjaro. Any adventures on the horizon for this year?*
