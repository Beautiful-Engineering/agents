...
Connection request? Start by sending them blank without a connection request message. Why? You'll often times get less accepted requests if you include a note. The folks from Lavender AI hypothesize this is because you're more likely to give them a reason *not* to accept.
...
- **Review your last cold emails or LI messages you've sent.**
- **Audit them, do they adhere to the lessons above?**
- **If not, create 1-3 new cold outreach messages optimized for response rate. **
