...
If you've determined that virality is worth pursuing, you need to understand the four main types of viral loops and their characteristics.

### Word-of-Mouth Virality: The Brand-Driven Loop

**What it is:** Users love your product so much they naturally tell others about it.

**Characteristics:**

- **Ramp-up time:** Moderate (improves as product improves)
- **Ceiling potential:** Moderate
- **Control level:** Indirect (function of product quality and brand)
...
- Apps that solve painful, visible problems
- Products with clear, measurable outcomes
- Brands people feel good about using
**Examples:**

- **Notion:** Users share templates and workflows because it makes them look organized and productive
- **Duolingo:** The owl mascot and streak features are memorable enough that users naturally mention their language learning
...
### Pull Virality: The Network-Driven Loop

**What it is:** Your product becomes more valuable when users invite others to join them, so they actively pull people in.

**Characteristics:**

- **Ramp-up time:** Medium (requires product-market fit)
- **Ceiling potential:** High
- **Control level:** High (you can optimize invitation flows)
...
- Any app where having friends/colleagues makes it better
**Examples:**

- **Slack:** You invite your team because the product only works when everyone's on it
- **Figma:** Designers invite stakeholders to comment on designs
- **Venmo:** You add friends so you can easily split bills and send money
- [MarkUp](https://www.markup.io/) lets you leave comments on design mockups. In order to leave feedback on a design, you have to use MarkUp.
- [Spotify](https://open.spotify.com/) users can create playlists of their favorite songs, then share them with friends or anyone else who might be interested.
The key insight: Users pull others in because they **need** them to participate to get full value from the product.

### Push Virality: The Content-Exposure Loop

**What it is:** Normal product usage naturally exposes your brand to potential customers.

**Characteristics:**

- **Ramp-up time:** Long (requires exceptional product-market fit)
- **Ceiling potential:** Highest
- **Control level:** Medium (you can optimize shareability)
...
- Apps that create shareable content
- Products with visible outputs
- Services with public-facing elements
...
- **TikTok:** Every video shared to other platforms exposes the TikTok watermark
- **Canva:** "Made with Canva" watermarks on free designs
- **VSCO:** Edited photos shared to other social platforms often drive people to ask "what filter is that?"
This is often a nice-to-have rather than essential. Don't force it if it doesn't fit naturally.

### Incentivized Virality: The Reward-Driven Loop

**What it is:** Users refer others in exchange for rewards (credits, discounts, premium features).

**Characteristics:**

- **Ramp-up time:** Fast (immediate motivation)
- **Ceiling potential:** Lowest (network effects fade quickly)
- **Control level:** Highest (you set the incentives)
...
- Users already have some desire to share (social or utility capital)
- The referral action connects to your product's core value
- The reward aligns with what users actually want
**Best for:**

- Apps with clear economic value
- Services where word-of-mouth needs a "nudge"
- Products with strong unit economics that can afford rewards
**Examples:**

- **Cash App:** Cash rewards for referrals make sense for a money app
- **Spotify:** Free Premium months for referrals reduce churn and align with user value
- **Dropbox:** Extra storage rewards connected directly to the core product benefit
...
- Generic rewards that don't match your product (Amazon gift cards for a meditation app)
- Pushing referrals before users understand your value
- Complex rules that confuse users
- Rewarding top-of-funnel actions instead of meaningful conversions
