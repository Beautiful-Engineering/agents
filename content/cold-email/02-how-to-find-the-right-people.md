...
- Create a strategy to locate more people like them and craft messaging to them accordingly. We’ll cover this below.
...
Use the [Jobs To Be Done** **](/lessons/jobs-to-be-done-jtbd-framework)framework for ongoing interviews: Interview people at the time that they switched to you so you can:
...
- You already know they’re motivated to solve the problem that your business solves—they’ve already paid for a solution to that problem.
...
If you use Salesforce, you’ll end up on [Trailhead](https://trailhead.salesforce.com/), their tutorial site, at some point. And if you ever have problems with their product, you’ll start posting in their [forums](https://trailhead.salesforce.com/trailblazer-community/topics/forumscommunity?sort=LAST_MODIFIED_DATE_DESC). Or maybe you’ll seek solutions in a shared slack group.
...
- Find third-party review sites like GetApp, TrustRadius, Capterra and find the names of reviewers. Then use [Clearbit](https://clearbit.com/) to get their contact information.
- Use [BuiltWith](https://builtwith.com/) to profile prospects by the technologies present on their websites—you can set up alerts when tech is added/removed so that you know when to reach out.
