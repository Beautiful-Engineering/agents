...
[Dux-Soup](https://www.dux-soup.com/) is a popular Chrome plugin that automates LinkedIn connecting. Alternatives we've heard good things about include [Phantom Buster](https://phantombuster.com/) and [We-connect](https://we-connect.io/).
