...
- Optimizing your profile for SEO and followers
- Interacting with other accounts
- Pursuing organic partnerships and collaborations
...
- **Gifting**: Send influencers free products in exchange for content promotion. Keep in mind that the bigger the influencer, the more engaged and loyal their audiences are likely to be. They might be more stringent with who they partner with, and likely past the point of gifting as an attractive offer.
- **Share-for-share (S4S)**: The same as gifting, but for mutual content promotion.
...
- Use swipe-ups to drive traffic
- Test different profile links
...
**TIP**: If you are going to use this strategy, make sure your landing page is optimized for mobile experience.
...
If you want to drive traffic to multiple destinations off-app, consider using an Instagram link service like [Linktree](https://linktr.ee/) or [Linkin.bio](https://later.com/link-in-bio/). 
...
Provided your company sells products that are eligible and compliant with Instagram’s [terms and policies](https://www.facebook.com/policies_center/commerce), this shopping feature lets you to list products for sale and link to them directly in your content.

Setting up a store page is pretty straightforward. All you need is a business account, and make sure you [meet the requirements](https://help.instagram.com/1627591223954487?helpref=uf_permalink). You can even take it one step further and set up [Instagram Checkout](https://www.facebook.com/business/help/449169642911614) for a completely native ecom shopping experience.
...
- [Later](https://later.com/#ref=elisedarma) for post scheduling. With Later, you can pre-plan your posts, for various times in a day, week, or month — with the context, tags, and hashtags, if you wish.
- [Dollar Eighty](https://dollareighty.com/?ref=joshryan8) for fast and convenient interactions on desktop.
- [Facebook Creator Studio](https://business.facebook.com/creatorstudio/home) for manual posting on desktop.

#### Tracking and analytics

- [Flick](https://www.flick.tech/?fpr=josh-ryan57) or [Iconosquare](https://pro.iconosquare.com/) for hashtag research.
- [Modash](https://www.modash.io/) spam checker and influencer research tool.
- [Instagram Insights](https://www.facebook.com/help/instagram/788388387972460) is Instagram’s free built-in analytics tool.

#### Image editing & design

- [Word Swag](http://wordswag.co/), a simple image and text overlay mobile app.
- [Canva](https://www.canva.com/) for content creation on desktop.
- [Flockler](https://flockler.com/free-tools/instagram-caption-generator) to write clean, nicely-formatted captions to copy and paste.

#### Video editing

- [Wavve](https://wavve.co/share-podcast-instagram-stories/) lets you turn a podcast clip into an Instagram Story.
- [Inshot](https://apps.apple.com/us/app/inshot-video-editor/id997362197) is a popular all-purpose video editing app for mobile devices.
- [Clips](https://apps.apple.com/us/app/clips/id1212699939) is a nifty app that adds subtitles to your videos while you record.
...
- Delete bought or fake followers. To remove followers manually, tap the follower number in your profile and start removing followers. If you have more than 5k followers, consider [hiring someone](https://www.fiverr.com/share/1WrRPK) for $25 to do this work for you.
...
- Buy followers, likes, or use automated engagement tools, services, or bots. Fake engagement may inflate your vanity metrics, but it won’t contribute to your growth. And it’s not worth the risk of breaking Instagram’s terms of service and getting your account banned.
