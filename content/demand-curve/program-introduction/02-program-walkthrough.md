...
By now you’ve already gone through onboarding, chosen your company path, and started your first lessons. This guide will give you a quick tour of the platform so you always know where things live and how to get the most of the program.

## 🖥 Dashboard

Your dashboard is **home base.** This is the place you’ll always come back to for a birds-eye view of the entire program.

From here you can:

- **Jump into your active path.** This keeps you moving forward in the structured plan we built for you during onboarding. (The Syllabus is where you can find the breakdown of courses inside your path.)
- **Explore the full content library.** Sometimes you’ll want to wander outside your path—say you hit a new challenge or want to preview what’s coming. Explore lets you dip into any course in the library.
...
Let’s look at each section of the course one by one.
...
> 👉 Paths are for **clarity and confidence.** They keep you from second-guessing what to do next.
...
- Maybe you’re in the B2B path, but you also want to peek at a B2C lesson like Google Shopping.
- Maybe you’re curious about a topic you’ll tackle later, like retention or CRO.
- Or maybe you just need a quick tactic outside your structured plan.
What you’ll see:
...
My Learning is your **personal workspace inside the program**.
...
- You can always **resume where you left off** without digging.
- If a course ends up not being relevant, you can **unenroll with one click**—keeping your workspace clean and focused.
- Saved courses live here too, so whenever you’re ready to explore something new, it’s right at your fingertips.

> 👉 Think of My Learning as your **organized desk. O**nly the things you care about stay in front of you.
...
- **Tactics Vault:** bite-sized growth tactics (from our newsletter) you can apply right away.
- **Ads Vault:** curated swipe file of ad creatives to inspire your campaigns.
- **Newsletter Archive:** every issue we’ve ever published.
- **Growth Guide:** our “80/20” starter guide to growth if you want a quick overview before going deep.
...
- Change **password or billing info** as needed

> 👉 Keep this updated—especially your company details—so the system (and Copilot) always give you the most relevant recommendations.

## 🤖 AI Growth Copilot

Copilot is your **AI growth partner,** built directly into the platform.

What it can do:

- Knows your onboarding info, your active path, and which lessons you’ve completed
