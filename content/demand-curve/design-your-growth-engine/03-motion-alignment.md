...
- **Time to Ignite:** How long it takes for a motion to reach its full velocity potential.
- **Velocity:** Once established, how quickly a motion moves users through it.
- **Commitment:** The level of effort a user must give to move through a motion.
- **Cost:** the resources required to build and run the motion.
...
#### Acquisition Motions
      ...
      **Virality-led**
      Slow (needs critical mass before flywheel spins)
      Very high
    
    
      **Paid-led**
      Fast (can theoretically be scaled instantly)
      Fast (traffic converts quickly if aligned)
    
    
      **Content-led**
      Slow (takes a long time to build library & distribution)
      Medium (steady flow once compounding)
    
    
      **Sales-led**
      Medium (requires reps + pipeline)
      Slow (limited by human bandwidth)
...
#### Monetization Motions
      ...
      **Hybrid**
      Varies by degree sales plugs in
      Varies by degree sales plugs in
    
    
      **Sales-led**
      Slow (constrained by hiring)
      Slow (long cycle, limited by human bandwidth)
...
High-velocity motions, such as virality and paid, tend to require **lighter, leaner asks** because that’s what makes them move quickly in the first place. They can spread quickly, but it’s hard to pack much context into such lightweight units.
...
- **Cost to acquire a customer** (your acquisition motion + monetization motion for first purchase)
- **Cost to retain and expand a customer** **value** (your retention motion + monetization motion for recurring/expansion revenue)
...
Here’s how the common combinations line up:
      ...
      **"True PLG"**
      ...
      Channel-led (Virality/Content/Paid)
      Hybrid
...
For B2B companies, your motion choices also set the tone **for your org design**. A self-serve dominant motion means marketing and product must carry more weight. A sales-led dominant motion means sales headcount will scale linearly with growth. Make sure your motions structure is one your Guardrails can actually support.
