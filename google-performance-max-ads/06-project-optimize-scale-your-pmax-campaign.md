...
- Unfortunately the metrics you can see are more limited. **Namely, you can't see the Cost associated to each asset, you can only see the Conversions, Conversion Value, and "Performance" metrics.**
- How to analyze:
...
We generally believe in letting Google do its thing, especially with Performance Max, but if there are emerging winners and losers for Devices and Location we should probably listen when your budget is limited.
