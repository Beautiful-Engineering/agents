...
- Do Target CPA if your conversion doesn't have revenue attached (signups or leads). Do Target ROAS if your conversion has revenue (purchases).
...
- Review all settings, assets, and targeting signals for errors (e.g., disapproved images, missing descriptions).
