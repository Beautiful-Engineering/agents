...
- ‍**Layer 1: Model-Channel Fit** helps us filter by unit economic viability. We eliminate entire channel categories that don't align with our ARPU and target CAC.
- ‍**Layer 2: Product-Channel Fit** rules out channels that don’t align with the DNA of your product—including complexity (and friction as a whole), as well as technical compatibility.
- ‍**Layer 3: Market-Channel Fit** helps us understand, *within* the viable channel category, where our audience actually spends time. We can filter out specific channels depending on where we can or cannot reach our target market.
- ‍**Layer 4: Guardrails** takes us even deeper. We can layer on the guardrail component of our system—you’ll get into this in Part 3—to get more granular about exactly which channels are viable based on our current goals and the constraints we're working within. For example, while you may have aggressive long-term company goals, if your primary short-term constraint is time—meaning you must produce certain results within a short timeframe—we can layer that on top of this framework to filter out channels that have a longer time-to-result.
