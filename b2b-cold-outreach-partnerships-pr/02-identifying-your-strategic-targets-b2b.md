...
- **Slack + Zoom:** Deep integration that made Slack stickier and expanded Zoom’s enterprise footprint
- **HubSpot + Stripe:** HubSpot users can accept payments natively, Stripe gains new SMB adoption
...
- **Gong + Pavilion:** Co-hosted events and reports to reach Pavilion’s sales leader audience
- **Morning Brew + Typeform:** Sponsored newsletter sections featuring Typeform's surveys and forms for business use cases
- **Salesforce + McKinsey:** Joint thought leadership reports positioning Salesforce as an enterprise leader
...
- **Gong + Mark Cranney (ex-Andreesen Horowitz Operating Partner):** Advised Gong on enterprise sales motion and scaling revenue teams.
- **Stripe + Peter Thiel:** Early advisor and investor who helped shape Stripe's market strategy and provided credibility
- **Atlassian + Doug Burgum (Great Plains Software):** Helped shape Atlassian’s early enterprise GTM approach.
...
- **Zoom + Salesforce AppExchange:** Listing drove adoption in Salesforce-heavy orgs and boosted enterprise sales.
...
#### Step 5: Value Proposition Development (10 minutes)

**‍**Based on research, your value prop could be:
...
.tg .tg-z6br{background-color:#f3f3b6;font-weight:bold;text-align:center;vertical-align:middle}
    ...
    Media
    5M monthly
    Wrote about productivity tools
    Product review
    High
    ...
    Newsletter
    50K subscribers
    Surpassed 50k subscribers last week
    Sponsorship
    Medium