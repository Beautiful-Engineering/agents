...
- **Hybrid:** both self-serve and sales paths available to prospects.
 It’s worth noting that there are different flavors of hybrid motions:
- **Product-led with sales assist**: users sign up, then sales intervenes selectively with high-value accounts.
- **Sales-led + Self-serve option**: most prospects go through sales, but individuals/SMBs/startups are offered a self-serve flow.
- **Full hybrid**: prospects can choose either path, and upgrades/expansions can be driven by either customer or sales.
