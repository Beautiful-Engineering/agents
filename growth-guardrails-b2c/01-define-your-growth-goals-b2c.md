...
Now in Part 4, we begin building your **Growth Engine** — an interconnected system of flywheels and supporting tactics that scalably and repeatedly generate more customers.
...
- **Your goals** — where you want to go, how you want to get there, and what you need to learn to make it a reality.
- **Your key constraints** — the practical filters of budget, time, team, market, and brand.
- **Your growth economics** — the guardrails that set the bounds of what’s financially viable.
...
- **Learning goals** — the risky assumptions and untested hypotheses that must be validated to reduce risk and move forward confidently.
- **Financial goals** — the financial performance milestones that prove you’re on track, as well as the long-term financial goal.
- **Personal goals** — the goal we push all founders to define early on that informs **how **you want to go about reaching your long-term goal.
...
- Have we built a product that our market actually wants?
- How can we consistently and predictably attract more users?
...
- **Scale:** “We can profitably acquire X users per month. We need to validate if we can scale by 3X without breaking model-channel alignment.”
- **Efficiency:** “We’re acquiring the right users, but our business isn’t sustainable at the current CAC. We need to validate if we can reduce our CAC below Y.”
- **Model fit:** “We haven’t started monetizing users yet. Before we think about scale, we need to validate our monetization strategy and unit economics.”
- **Brand fit:** “Once users get into our product, they love it. But we’ve learned many people do not understand our product value based on our current messaging. We need to identify the optimal messaging so users instantly “get it” before actually using the product.”
...
### **Your Input: What Are You Trying to Validate?**

In a sentence or two, describe the key assumption or hypothesis you want to validate in this stage of your growth.

**Open up your **[**Master Strategy Project**](https://demandcurve.notion.site/Master-Strategy-Project-256f852211328013897fc2aa816684c6?source=copy_link)**. Add your input to the “Primary Learning Goal” within the Growth Guardrails section.**
...
- **Bootstrapped companies** usually need to reach **cash flow sustainability** ASAP.
- **Pre-seed and seed-stage companies** often need to **build a traction story** that can support additional fundraising.
- **VC-backed companies** typically have **aggressive growth targets** tied to revenue or user base growth.
More broadly, short/mid-term goals can generally be categorized by:

- **Efficiency goals**,** **such as achieving profitability.
- **Growth rate goals, **such as demonstrating consistent 20% month-over-month user growth.
- **Scale goals, **such as increasing revenue from $1M ARR to $5M ARR.
...
### **Your Input: What’s Your Primary Financial Goal?**
...
### Your Input: What are your Personal Goals?
