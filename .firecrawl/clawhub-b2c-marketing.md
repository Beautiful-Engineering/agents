[![](https://clawhub.ai/clawd-logo.png)ClawHub](https://clawhub.ai/) [Skills](https://clawhub.ai/skills) [Upload](https://clawhub.ai/upload) [Import](https://clawhub.ai/import) [Search](https://clawhub.ai/skills?focus=search)
...
⭐ 15 ·  1.1k · 2 current installs · 2 all-time installs

by![](https://avatars.githubusercontent.com/u/112214002?v=4) [@jackfriks](https://clawhub.ai/u/jackfriks)
...
[View report →](https://www.virustotal.com/gui/file/afed855f76f18c312d41a1aec2b3184bdf0adcdcd22f794a2e6edafb90a2bcad)
...
Coach the user: _"Your bio is your storefront. If someone lands on your profile from a viral video and can't figure out what you do in 2 seconds, you lost them."_
...
5. 3 days of activity _sometimes_ works but 7 is safest — don't rush this
...
Coach the user: _"I know it feels like wasted time. It's not. Every account I've rushed has struggled. Every account I've built properly has grown faster. 7 days of patience saves you months of frustration."_
...
Coach the user: _"Finding content-market fit is like finding product-market fit — it takes iteration. The difference is each iteration only takes 10 minutes to make a video. You can test 30 formats in a month. Most businesses never get that kind of feedback loop."_
...
Coach the user: _"Trends are free momentum. When the chill guy was going viral, I made a few videos for my app and got 100K+ views each. But trends come and go — your proven format is what sustains growth."_
...
- Docs: `workspace/post-bridge-api.json` or [https://api.post-bridge.com/reference](https://api.post-bridge.com/reference)

### Posting Flow

1. Upload media → `POST /v1/media/create-upload-url` → get `media_id` \+ `upload_url`
2. PUT file to `upload_url`
3. Create post → `POST /v1/posts` with caption, media IDs, social\_account IDs
...
01. Receive video files from user (local folder or upload)
02. Extract a frame with ffmpeg to read any text overlays:
...
03. Write caption based on video content + proven hook formulas
04. Upload each video via Post Bridge media API
05. Create posts staggered throughout the day (3-4 hour gaps)
06. Post to all connected platforms simultaneously
07. Set cron checks 5 minutes after each scheduled post
08. Move posted videos to `posted/` subfolder
09. Track performance and report results
...
references/formats.md3.1 KBreferences/larry-case-study.md6.0 KBSKILL.md16 KB
