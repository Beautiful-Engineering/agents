...
- If you have an ecomm business and payback is instantaneous, you can scale quickly.
...
**Conversions** don't include view-throughs. View-throughs are only relevant for Display and YouTube ads. In the example above, even though we’re considering the **Signup** conversion to be the most important (because of a long time delay between ad click and **Purchase** conversion), we’re still interested in seeing how many people are completing each step. It lets us see if there’s a big drop-off in the funnel, and whether people engage with a specific campaign or keyword.
...
- Note that Search Terms don't show all searches, just some of them, due to privacy concerns.
...
- **Pause Underperformers**: Pause keywords, ads, or ad groups with:
...
- **Scale Winners**:
- If an ad group is outperforming others, consider moving it to its own campaign so you can increase its budget relative to everything else. 
